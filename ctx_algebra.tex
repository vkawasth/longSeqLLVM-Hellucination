...
\textbf{Conclusion:}
GPT-2-medium attention transition matrices are upper Hessenberg in the
$W_K$ eigenvector basis with violation $0.046$ ($10\sigma$ below random).
The discrete Toda structure is computational, not merely formal.
Each attention step in GPT-2-medium implements a Toda Lax matrix QR update
in the basis defined by the key projection.
